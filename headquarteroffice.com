...
if($show==1){
			...
			If you have any headquarters for the company. Please <a href="profile.php"> <b style="font-size:18px">Click here </b></a> to enter your Headquarters details.<br>
			</div>
			  <?php
        }
	if($show==2) {
			  ...
			  echo $smsg;
			  ?>
			  <a href="profile.php"> Click here </a> to enter Company Information again.<br>
			  <?php
	}
?>
<?php
if($show==0){
	...
	<div class="col-md-6">
			...
			?>
				<div class="col-md-12">
					<input type="text" name="companyname" class="form-control formlarge mt17" placeholder="Name of Comapny" required>
				</div>
					<div class="col-md-12">
					...
					<div class="col-md-12">
					<input type="text" name="companycategory" class="form-control formlarge mt17" placeholder="Company Category" required>
					</div>
					<div class="col-md-12">
					<input type="text" name="exposedcategory" class="form-control formlarge mt17" placeholder="Exposed Category" required>
					</div>
			<?php }else{
                  if($rowinfo['street']==''){
					  $_SESSION['compalready']="yes";
					  $_SESSION['compid']=$_rowinfo['compid'];
					  
			?>
			<div class="col-md-12">
					<input type="text" name="companyname" value="<?php echo $rowinfo['company_name']; ?>" class="form-control formlarge mt17" placeholder="Name of Comapny" required>
				</div>
					<div class="col-md-12">
				  ...
				  <?php } ?>
					...
					<div class="col-md-12">
					<input type="text" value="<?php echo $rowinfo['category']; ?>" name="companycategory" class="form-control formlarge mt17" placeholder="Company Category" required>
					</div>
					<div class="col-md-12">
					<input type="text" value="<?php echo $rowinfo['exposed_category']; ?>" name="exposedcategory" class="form-control formlarge mt17" placeholder="Exposed Category" required>
					</div>
			...
			<?php }} ?>
				...
				<div class="col-md-12">
					<input type="text" name="city" class="form-control formlarge mt17" placeholder="City" required>
				</div>
				<div class="col-md-12">
					<input type="text" name="postalcode" class="form-control formlarge mt17" placeholder="Postal Code" required>
				</div>
...
<option value="Zimbabwe">Zimbabwe</option>
		...
		<div class="col-md-6">
		<div class="col-md-12">
					<input type="text" name="province" class="form-control formlarge mt17" placeholder="Province" required>
				</div>
				<div class="col-md-12">
				...
				<div class="col-md-12">
					<input type="text" name="telephone" class="form-control formlarge mt17" placeholder="Telephone" required>
				</div>
					<div class="col-md-12">
					<input type="text" name="fax" class="form-control formlarge mt17" placeholder="Fax" required>
				</div>
				...
				<div class="col-md-12">
					<input type="text" name="website" class="form-control formlarge mt17" placeholder="website" required>
				</div>
		</div>
